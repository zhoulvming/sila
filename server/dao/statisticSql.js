...
+' ) se group by se.ref) uv on pv.ref=uv.ref',

//流量来源--概览--饼图右边的列表  外部链接的pv,uv
	list2:'SELECT pv.ref,pv.pv_num,uv.uv_num from '
...
//流量来源--概览--饼图右边的列表  直接访问的pv,uv
	list3:'SELECT pv.ref,pv.pv_num,uv.uv_num from '
